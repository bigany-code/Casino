...
let coinAnimation = document.querySelector('#coinAnim');

function removeClass() {
    coinAnimation.classList.remove("heads")
    coinAnimation.classList.remove("tails")
}
function addClass(flipResult) {
    coinAnimation.classList.add(flipResult)
}
